...
module ActionView
  ...
  class << self
    # pkg:gem/actionview#lib/action_view.rb:90
    def eager_load!; end
...
# = Action View Errors
#
# pkg:gem/actionview#lib/action_view/template/error.rb:7
...
class ActionView::Base
  ...
  # pkg:gem/actionview#lib/action_view/base.rb:240
  def _run(method, template, locals, buffer, add_to_stack: T.unsafe(nil), &block); end

  # pkg:gem/actionview#lib/action_view/base.rb:163
  def annotate_rendered_view_with_filenames; end

  # pkg:gem/actionview#lib/action_view/base.rb:163
  def annotate_rendered_view_with_filenames=(val); end

  # pkg:gem/actionview#lib/action_view/base.rb:207
  def assign(new_assigns); end

  # pkg:gem/actionview#lib/action_view/base.rb:203
  def assigns; end

  # pkg:gem/actionview#lib/action_view/base.rb:203
  def assigns=(_arg0); end

  # pkg:gem/actionview#lib/action_view/base.rb:160
  ...
  # pkg:gem/actionview#lib/action_view/base.rb:142
  ...
  # pkg:gem/actionview#lib/action_view/base.rb:145
  def field_error_proc; end

  # pkg:gem/actionview#lib/action_view/base.rb:145
  def field_error_proc=(val); end

  # pkg:gem/actionview#lib/action_view/base.rb:205
  def formats(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actionview#lib/action_view/base.rb:205
  def formats=(arg); end

  # pkg:gem/actionview#lib/action_view/base.rb:257
  ...
  # pkg:gem/actionview#lib/action_view/base.rb:154
  ...
  # pkg:gem/actionview#lib/action_view/base.rb:149
  ...
  class << self
    ...
    # pkg:gem/actionview#lib/action_view/base.rb:175
    def cache_template_loading=(value); end

    # pkg:gem/actionview#lib/action_view/base.rb:197
    ...
    # pkg:gem/actionview#lib/action_view/base.rb:276
    ...
    # pkg:gem/actionview#lib/action_view/base.rb:169
...
class ActionView::CacheExpiry::Executor
  ...
  # pkg:gem/actionview#lib/action_view/cache_expiry.rb:20
  def complete(_); end

  # pkg:gem/actionview#lib/action_view/cache_expiry.rb:13
  def run; end

  private

  # pkg:gem/actionview#lib/action_view/cache_expiry.rb:25
  def clear_cache; end
end
...
class ActionView::CacheExpiry::ViewModificationWatcher
  ...
  # pkg:gem/actionview#lib/action_view/cache_expiry.rb:41
  def execute_if_updated; end

  private

  # pkg:gem/actionview#lib/action_view/cache_expiry.rb:61
  def all_view_paths; end

  # pkg:gem/actionview#lib/action_view/cache_expiry.rb:57
...
module ActionView::CollectionCaching
  ...
  # pkg:gem/actionview#lib/action_view/renderer/partial_renderer/collection_caching.rb:70
  ...
  #
  # pkg:gem/actionview#lib/action_view/renderer/partial_renderer/collection_caching.rb:90
...
class ActionView::CollectionRenderer < ::ActionView::PartialRenderer
  ...
  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:122
  def render_collection_derive_partial(collection, context, block); end

  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:104
  def render_collection_with_partial(collection, partial, context, block); end

  private

  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:174
  def collection_with_template(view, template, layout, collection); end

  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:145
  def render_collection(collection, view, path, template, layout, block); end

  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:140
...
# pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:92
class ActionView::CollectionRenderer::MixedCollectionIterator < ::ActionView::CollectionRenderer::CollectionIterator
  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:93
  def initialize(collection, paths); end

  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:98
  def each_with_info; end
end

# pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:74
class ActionView::CollectionRenderer::PreloadCollectionIterator < ::ActionView::CollectionRenderer::SameCollectionIterator
  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:75
  ...
  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:81
  def from_collection(collection); end
end

# pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:56
class ActionView::CollectionRenderer::SameCollectionIterator < ::ActionView::CollectionRenderer::CollectionIterator
  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:57
  def initialize(collection, path, variables); end

  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:67
  def each_with_info; end

  # pkg:gem/actionview#lib/action_view/renderer/collection_renderer.rb:63
  def from_collection(collection); end
end
...
class ActionView::FileSystemResolver < ::ActionView::Resolver
  ...
  # pkg:gem/actionview#lib/action_view/template/resolver.rb:109
  def to_path; end

  # pkg:gem/actionview#lib/action_view/template/resolver.rb:106
  def to_s; end
  ...
  # pkg:gem/actionview#lib/action_view/template/resolver.rb:145
  def build_unbound_template(template); end

  # pkg:gem/actionview#lib/action_view/template/resolver.rb:203
  def escape_entry(entry); end

  # pkg:gem/actionview#lib/action_view/template/resolver.rb:175
  def filter_and_sort_by_details(templates, requested_details); end

  # pkg:gem/actionview#lib/action_view/template/resolver.rb:141
  def source_for_template(template); end

  # Safe glob within @path
  #
  # pkg:gem/actionview#lib/action_view/template/resolver.rb:190
  def template_glob(glob); end

  # pkg:gem/actionview#lib/action_view/template/resolver.rb:158
...
#
# pkg:gem/actionview#lib/action_view/helpers/capture_helper.rb:7
module ActionView::Helpers
  ...
  class << self
    # pkg:gem/actionview#lib/action_view/helpers.rb:34
    def eager_load!; end
  end
end

# pkg:gem/actionview#lib/action_view/helpers/active_model_helper.rb:9
...
#
# pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:20
module ActionView::Helpers::AssetTagHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:486
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:235
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:276
  ...
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:24
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:394
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:89
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:319
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:170
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:459
  def video_tag(*sources); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:527
  def check_for_image_tag_errors(options); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:518
  ...
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:508
  def resolve_image_source(source, skip_pipeline); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:533
  def resolve_link_as(extname, mime_type); end

  # Some HTTP client and proxies have a 8kiB header limit
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:544
...
# pkg:gem/actionview#lib/action_view/helpers/asset_tag_helper.rb:543
...
#   )
#
# pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:120
module ActionView::Helpers::AssetUrlHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:186
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:230
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:429
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:441
  def audio_url(source, options = T.unsafe(nil)); end

  # Compute extname to append to asset path. Returns +nil+ if
  # nothing should be added.
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:242
  ...
  # (proc or otherwise).
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:276
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:265
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:454
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:466
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:377
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:389
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:320
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:332
  def javascript_url(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:218
  def path_to_asset(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:432
  def path_to_audio(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:457
  def path_to_font(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:380
  def path_to_image(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:323
  def path_to_javascript(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:350
  def path_to_stylesheet(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:406
  def path_to_video(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:269
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:347
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:359
  def stylesheet_url(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:233
  def url_to_asset(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:444
  def url_to_audio(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:469
  def url_to_font(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:392
  def url_to_image(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:335
  def url_to_javascript(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:362
  def url_to_stylesheet(source, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:418
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:403
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:415
  def video_url(source, options = T.unsafe(nil)); end
end

# aliased to avoid conflicts with an asset_url named route
#
# pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:235
ActionView::Helpers::AssetUrlHelper::ASSET_EXTENSIONS = T.let(T.unsafe(nil), Hash)

# Maps asset types to public directory.
#
# pkg:gem/actionview#lib/action_view/helpers/asset_url_helper.rb:253
...
# pkg:gem/actionview#lib/action_view/helpers/cache_helper.rb:295
module ActionView::Helpers::CacheHelper::CachingRegistry
  extend ::ActionView::Helpers::CacheHelper::CachingRegistry

  # pkg:gem/actionview#lib/action_view/helpers/cache_helper.rb:298
  def caching?; end

  # pkg:gem/actionview#lib/action_view/helpers/cache_helper.rb:302
...
#
# pkg:gem/actionview#lib/action_view/helpers/capture_helper.rb:13
module ActionView::Helpers::CaptureHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/capture_helper.rb:43
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/capture_helper.rb:155
  ...
  #   </html>
  #
  # pkg:gem/actionview#lib/action_view/helpers/capture_helper.rb:195
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/capture_helper.rb:175
  def provide(name, content = T.unsafe(nil), &block); end

  # Use an alternate output buffer for the duration of the block.
  # Defaults to a new empty string.
  #
  # pkg:gem/actionview#lib/action_view/helpers/capture_helper.rb:201
...
#
# pkg:gem/actionview#lib/action_view/helpers/controller_helper.rb:9
module ActionView::Helpers::ControllerHelper
  # pkg:gem/actionview#lib/action_view/helpers/controller_helper.rb:16
  ...
  # pkg:gem/actionview#lib/action_view/helpers/controller_helper.rb:10
  def controller; end
  ...
  # pkg:gem/actionview#lib/action_view/helpers/controller_helper.rb:26
  def logger; end
  ...
  # pkg:gem/actionview#lib/action_view/helpers/controller_helper.rb:30
...
module ActionView::Helpers::DateHelper
  ...
  # The selects are prepared for multi-parameter assignment to an Active Record object.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:362
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:450
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:411
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:593
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:566
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:537
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:638
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:513
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:490
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:667
  ...
  # all month choices are valid.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:327
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:686
...
class ActionView::Helpers::DateTimeSelector
  ...
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:752
  def select_date; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:731
  def select_datetime; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:814
  def select_day; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:802
  def select_hour; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:794
  def select_minute; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:822
  def select_month; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:786
  def select_second; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:770
  def select_time; end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:836
  def select_year; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1066
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1167
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1023
  def build_options(selected, options = T.unsafe(nil)); end

  # Build full select tag from date type and options.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:999
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1205
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1090
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1132
  def css_class_attribute(type, html_options_class, options); end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:981
  def date_order; end
  ...
  #   day_name(1) # => "1st"
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:921
  ...
  #  => "post_written_on_1i"
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1196
  def input_id_from_type(type); end

  # Returns the name attribute for the input tag.
  #  => post[written_on(1i)]
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1182
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:952
  def month_name(number); end

  # Returns translated month names, but also ensures that a custom month
  # name array has a leading +nil+ element.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:888
  def month_names; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1148
  def prompt_option_tag(type, options); end

  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:874
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1216
  def separator(type); end

  # If the day is hidden, the day should be set to the 1st so all month and year choices are
  # valid. Otherwise, February 31st or February 29th, 2011 can be selected, which are invalid.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:880
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:905
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:973
...
# pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:709
...
#
# pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1230
class ActionView::Helpers::FormBuilder
  ...
  #   #     </button>
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2619
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2443
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:907
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:859
  def collection_select(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2008
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1239
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1263
  def datetime_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2008
  def email_field(method, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2640
  def emitted_hidden_id?; end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1668
  ...
  # case).
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1760
  ...
  #   <% end %>
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1780
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2297
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2260
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2526
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:871
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2487
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1740
  def id; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2374
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1683
  def multipart=(multipart); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1681
  def multipart?; end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2008
  def number_field(method, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1678
  def object; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2465
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:847
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/date_helper.rb:1251
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:883
  ...
  # Please refer to the documentation of the base helper for details.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:895
  def weekday_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2725
  def convert_to_legacy_options(options); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2707
  def fields_for_nested_model(name, object, fields_options, block); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2678
  def fields_for_with_nested_attributes(association_name, association, options, block); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2674
  def nested_attributes_association?(association_name); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2720
  def nested_child_index(name); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2645
  def objectify_options(options); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:2651
  def submit_default_value; end

  class << self
    # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1691
...
#
# pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:111
module ActionView::Helpers::FormHelper
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1576
  ...
  #   #    <input type="checkbox" class="eula_check" id="eula_accepted" name="eula[accepted]" value="yes" />
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1339
  ...
  #   # => <input id="user_born_on" name="user[born_on]" type="date" min="2014-05-20" />
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1433
  ...
  #   # => <input id="user_born_on" name="user[born_on]" type="datetime-local" min="2014-05-20T00:00:00.000" />
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1500
  def datetime_field(object_name, method, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1504
  def datetime_local_field(object_name, method, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:119
  def default_form_builder; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1554
  ...
  # FormOptionsHelper#collection_select and DateHelper#datetime_select.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1073
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1022
  ...
  #   # => <input type="file" id="attachment_file" name="attachment[file]" class="file_input" />
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1241
  ...
  #   <% end %>
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:433
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1208
  ...
  #   # => <label for="post_terms">Accept <a href="/terms">Terms</a>.</label>
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1145
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1519
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1563
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1190
  ...
  #   #    <input type="radio" id="user_receive_newsletter_no" name="user[receive_newsletter]" value="no" checked="checked" />
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1361
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1572
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1392
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1401
  ...
  #   #    </textarea>
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1271
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1169
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1471
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1545
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1536
  def week_field(object_name, method, options = T.unsafe(nil)); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:463
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1581
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_helper.rb:1596
...
module ActionView::Helpers::FormOptionsHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:781
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:697
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:533
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:578
  ...
  # a regular HTML select tag.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:610
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:819
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:794
  def option_text_and_value(option); end

  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:804
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_options_helper.rb:829
...
#
# pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:17
module ActionView::Helpers::FormTagHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:578
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:444
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:676
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:746
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:777
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:847
  def email_field_tag(name, value = T.unsafe(nil), options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:23
  ...
  # case).
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:99
  ...
  #   <%# => <input type="text" name="post[tag][]">
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:129
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:344
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:75
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:305
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:624
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:278
  ...
  # * <tt>:step</tt> - The acceptable value granularity.
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:788
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:895
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:377
  def password_field_tag(name = T.unsafe(nil), value = T.unsafe(nil), options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:725
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:909
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:699
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:198
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:517
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:722
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:410
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:260
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:760
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:915
  ...
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:980
  def form_tag_html(html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:985
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:992
  def sanitize_to_id(name); end

  # pkg:gem/actionview#lib/action_view/helpers/form_tag_helper.rb:996
...
# pkg:gem/actionview#lib/action_view/helpers/javascript_helper.rb:5
module ActionView::Helpers::JavaScriptHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/javascript_helper.rb:27
  def escape_javascript(javascript); end

  # pkg:gem/actionview#lib/action_view/helpers/javascript_helper.rb:37
  def j(javascript); end

  # pkg:gem/actionview#lib/action_view/helpers/javascript_helper.rb:90
  ...
  #   <% end -%>
  #
  # pkg:gem/actionview#lib/action_view/helpers/javascript_helper.rb:74
...
#
# pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:16
module ActionView::Helpers::NumberHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:50
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:110
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:98
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:62
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:34
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:74
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:86
  def number_with_precision(number, options = T.unsafe(nil)); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:115
  def delegate_number_helper_method(method, number, options); end

  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:134
  def escape_units(units); end

  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:124
  def escape_unsafe_options(options); end

  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:157
  def parse_float(number, raise_error); end

  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:153
  def valid_float?(number); end

  # pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:140
...
#
# pkg:gem/actionview#lib/action_view/helpers/number_helper.rb:19
...
#
# pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:10
module ActionView::Helpers::SanitizeHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:92
  def sanitize(html, options = T.unsafe(nil)); end

  # Sanitizes a block of CSS code. Used by #sanitize when it comes across a style attribute.
  #
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:97
  ...
  #   # => &lt;malformed &amp; link
  #
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:131
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:114
  def strip_tags(html); end
end

# pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:135
module ActionView::Helpers::SanitizeHelper::ClassMethods
  ...
  #   end
  #
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:136
  ...
  #   end
  #
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:166
  ...
  #   end
  #
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:176
  ...
  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:146
  def sanitized_allowed_attributes; end

  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:142
  def sanitized_allowed_tags; end

  # pkg:gem/actionview#lib/action_view/helpers/sanitize_helper.rb:138
...
#
# pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:14
module ActionView::Helpers::TagHelper
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:408
  def cdata_section(content); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:393
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:368
  ...
  #   # => "&lt;&lt; Accept &amp; Checkout"
  #
  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:420
  ...
  #   # => <div class="highlight" />
  #
  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:331
  ...
  #    # => "123 foo bar"
  #
  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:388
  def token_list(*args); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:425
  def build_tag_values(*args); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:445
  def tag_builder; end

  class << self
    # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:443
    def build_tag_values(*args); end
  end
end

# pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:31
ActionView::Helpers::TagHelper::ARIA_PREFIXES = T.let(T.unsafe(nil), Set)

# pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:18
...
# pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:40
...
# pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:44
class ActionView::Helpers::TagHelper::TagBuilder
  ...
  #   # => <input type="text" aria-label="Search">
  #
  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:60
  def attributes(attributes); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:133
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:64
  def p(*arguments, **options, &block); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:137
  def tag_option(key, value, escape); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:91
  def tag_options(options, escape = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:68
  def tag_string(name, content = T.unsafe(nil), **options, &block); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:167
  def handle_deprecated_escape_options(options); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:188
  def method_missing(called, *args, **options, &block); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:155
  def prefix_tag_option(prefix, key, value, escape); end

  # pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:163
  def respond_to_missing?(*args); end
end

# pkg:gem/actionview#lib/action_view/helpers/tag_helper.rb:48
...
class ActionView::Helpers::Tags::Base
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:12
  def initialize(object_name, method_name, template_object, options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:10
  def object; end

  # This is what child classes implement.
  #
  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:32
  def render; end
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:82
  def add_default_name_and_id_for_value(tag_value, options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:147
  def add_options(option_tags, options, value = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:173
  def generate_ids?; end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:165
  def name_and_id_index(options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:142
  def placeholder_required?(html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:73
  def retrieve_autoindex(pre_match); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:62
  def retrieve_object(object); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:115
  def sanitized_method_name; end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:119
  def sanitized_value(value); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:123
  def select_content_tag(option_tags, options, html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:111
  def tag_id(index = T.unsafe(nil), namespace = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:107
  def tag_name(multiple = T.unsafe(nil), index = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:37
  def value; end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:45
  def value_before_type_cast; end

  # pkg:gem/actionview#lib/action_view/helpers/tags/base.rb:57
...
class ActionView::Helpers::Tags::CollectionCheckBoxes < ::ActionView::Helpers::Tags::Base
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tags/collection_check_boxes.rb:20
  def render(&block); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/tags/collection_check_boxes.rb:29
  def hidden_field_name; end

  # pkg:gem/actionview#lib/action_view/helpers/tags/collection_check_boxes.rb:25
  def render_component(builder); end
end

# pkg:gem/actionview#lib/action_view/helpers/tags/collection_check_boxes.rb:11
...
class ActionView::Helpers::Tags::CollectionRadioButtons < ::ActionView::Helpers::Tags::Base
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tags/collection_radio_buttons.rb:19
  def render(&block); end

  private

  # pkg:gem/actionview#lib/action_view/helpers/tags/collection_radio_buttons.rb:24
  def render_component(builder); end
end

# pkg:gem/actionview#lib/action_view/helpers/tags/collection_radio_buttons.rb:11
...
class ActionView::Helpers::Tags::CollectionSelect < ::ActionView::Helpers::Tags::Base
  # pkg:gem/actionview#lib/action_view/helpers/tags/collection_select.rb:7
  def initialize(object_name, method_name, template_object, collection, value_method, text_method, options, html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/collection_select.rb:16
  def render; end
end
...
class ActionView::Helpers::Tags::DateSelect < ::ActionView::Helpers::Tags::Base
  # pkg:gem/actionview#lib/action_view/helpers/tags/date_select.rb:9
  def initialize(object_name, method_name, template_object, options, html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/date_select.rb:15
  def render; end

  private

  # pkg:gem/actionview#lib/action_view/helpers/tags/date_select.rb:30
  def datetime_selector(options, html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/date_select.rb:43
  def default_datetime(options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/date_select.rb:26
  def select_type; end

  class << self
    # pkg:gem/actionview#lib/action_view/helpers/tags/date_select.rb:20
    def select_type; end
  end
end
...
class ActionView::Helpers::Tags::DatetimeField < ::ActionView::Helpers::Tags::TextField
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tags/datetime_field.rb:21
...
class ActionView::Helpers::Tags::DatetimeLocalField < ::ActionView::Helpers::Tags::DatetimeField
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tags/datetime_local_field.rb:14
  def format_date(value); end

  class << self
    # pkg:gem/actionview#lib/action_view/helpers/tags/datetime_local_field.rb:8
    def field_type; end
  end
end
...
class ActionView::Helpers::Tags::GroupedCollectionSelect < ::ActionView::Helpers::Tags::Base
  # pkg:gem/actionview#lib/action_view/helpers/tags/grouped_collection_select.rb:7
  ...
  # pkg:gem/actionview#lib/action_view/helpers/tags/grouped_collection_select.rb:18
  def render; end
end
...
class ActionView::Helpers::Tags::Select < ::ActionView::Helpers::Tags::Base
  # pkg:gem/actionview#lib/action_view/helpers/tags/select.rb:7
  def initialize(object_name, method_name, template_object, choices, options, html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/select.rb:16
  def render; end
  ...
  #   { nil => [] }
  #
  # pkg:gem/actionview#lib/action_view/helpers/tags/select.rb:36
...
class ActionView::Helpers::Tags::TimeZoneSelect < ::ActionView::Helpers::Tags::Base
  # pkg:gem/actionview#lib/action_view/helpers/tags/time_zone_select.rb:7
  def initialize(object_name, method_name, template_object, priority_zones, options, html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/time_zone_select.rb:14
  def render; end
end
...
class ActionView::Helpers::Tags::WeekdaySelect < ::ActionView::Helpers::Tags::Base
  # pkg:gem/actionview#lib/action_view/helpers/tags/weekday_select.rb:7
  def initialize(object_name, method_name, template_object, options, html_options); end

  # pkg:gem/actionview#lib/action_view/helpers/tags/weekday_select.rb:13
  def render; end
end
...
#   # => "<p>&lt;a href=\"http://example.com/\"&gt;Example&lt;/a&gt;</p>"
#
# pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:35
module ActionView::Helpers::TextHelper
  ...
  #   <% end %>
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:62
  ...
  #   <% end %>
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:436
  ...
  #  <% end %>
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:412
  ...
  #   # => "...a very beautiful..."
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:231
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:173
  ...
  #   # => "2 Personen"
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:286
  ...
  #   </table>
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:459
  def reset_cycle(name = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:66
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:358
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:121
  ...
  #   # => "Once\r\nupon\r\na\r\ntime"
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:316
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:504
  def get_cycle(name); end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:509
  def set_cycle(name, cycle_object); end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:514
  def split_paragraphs(text); end
end

# pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:464
class ActionView::Helpers::TextHelper::Cycle
  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:467
  def initialize(first_value, *values); end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:476
  def current_value; end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:472
  def reset; end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:480
  def to_s; end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:465
  def values; end

  private

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:487
  def next_index; end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:491
  def previous_index; end

  # pkg:gem/actionview#lib/action_view/helpers/text_helper.rb:495
...
# and controllers.
#
# pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:15
module ActionView::Helpers::UrlHelper
  ...
  #   #    </form>"
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:331
  def button_to(name = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:32
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:582
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:209
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:471
  ...
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:448
  ...
  #     %>
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:424
  ...
  #        </a>
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:521
  ...
  #        </a>
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:716
  ...
  #        </a>
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:665
  ...
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:47
  def _back_url; end

  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:52
  ...
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:753
  ...
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:807
  def method_tag(method); end

  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:853
  ...
  #   # => [{name: 'country[name]', value: 'Denmark'}]
  #
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:827
  def to_form_params(attribute, namespace = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:793
...
#
# pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:21
ActionView::Helpers::UrlHelper::BUTTON_TAG_METHOD_VERBS = T.let(T.unsafe(nil), Array)

# pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:26
module ActionView::Helpers::UrlHelper::ClassMethods
  # pkg:gem/actionview#lib/action_view/helpers/url_helper.rb:27
...
class ActionView::I18nProxy < ::I18n::Config
  ...
  # pkg:gem/actionview#lib/action_view/rendering.rb:16
  def locale; end

  # pkg:gem/actionview#lib/action_view/rendering.rb:20
...
#
# pkg:gem/actionview#lib/action_view/layouts.rb:203
module ActionView::Layouts
  ...
  # pkg:gem/actionview#lib/action_view/layouts.rb:215
...
class ActionView::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:59
  def logger; end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:42
  def render_collection(event); end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:35
  def render_layout(event); end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:25
  def render_partial(event); end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:17
  def render_template(event); end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:53
  def start(name, id, payload); end

  private

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:83
  def cache_message(payload); end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:65
  def from_rails_root(string); end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:92
  def log_rendering_start(payload, name); end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:71
  def rails_root; end

  # pkg:gem/actionview#lib/action_view/log_subscriber.rb:75
  def render_count(payload); end
end

# pkg:gem/actionview#lib/action_view/log_subscriber.rb:64
...
class ActionView::LookupContext
  ...
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:216
  def initialize(view_paths, details = T.unsafe(nil), prefixes = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/lookup_context.rb:226
  def digest_cache; end

  # Override formats= to expand ["*/*"] values and automatically
  # add :html as fallback to :js.
  #
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:247
  def formats=(values); end

  # Override locale to return a symbol instead of array.
  #
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:267
  def locale; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:274
  def locale=(value); end
  ...
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:230
  def with_prepended_formats(formats); end

  private

  # pkg:gem/actionview#lib/action_view/lookup_context.rb:237
...
#
# pkg:gem/actionview#lib/action_view/lookup_context.rb:94
module ActionView::LookupContext::DetailsCache
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:95
  def cache; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:104
  def disable_cache; end

  private

  # pkg:gem/actionview#lib/action_view/lookup_context.rb:112
...
class ActionView::LookupContext::DetailsKey
  ...
  class << self
    # pkg:gem/actionview#lib/action_view/lookup_context.rb:73
    def clear; end
    ...
    # pkg:gem/actionview#lib/action_view/lookup_context.rb:82
...
module ActionView::LookupContext::ViewPaths
  ...
  #
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:154
  ...
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:172
  def detail_args_for_any; end

  # Fix when prefix is specified as part of the template name
  #
  # pkg:gem/actionview#lib/action_view/lookup_context.rb:193
  def normalize_name(name, prefixes); end
end

# pkg:gem/actionview#lib/action_view/template/error.rb:29
class ActionView::MissingTemplate < ::ActionView::ActionViewError
  include ::DidYouMean::Correctable

  # pkg:gem/actionview#lib/action_view/template/error.rb:32
  ...
  #
  # pkg:gem/actionview#lib/action_view/template/error.rb:92
  def corrections; end
...
# pkg:gem/actionview#lib/action_view/template/error.rb:59
class ActionView::MissingTemplate::Results
  # pkg:gem/actionview#lib/action_view/template/error.rb:62
  ...
  # pkg:gem/actionview#lib/action_view/template/error.rb:67
  def to_a; end
end
...
class ActionView::OutputBuffer < ::ActiveSupport::SafeBuffer
  ...
  # pkg:gem/actionview#lib/action_view/buffers.rb:31
  def append=(value); end

  # pkg:gem/actionview#lib/action_view/buffers.rb:38
  def safe_append=(value); end

  # pkg:gem/actionview#lib/action_view/buffers.rb:33
...
class ActionView::PathSet
  ...
  # pkg:gem/actionview#lib/action_view/path_set.rb:60
  def exists?(path, prefixes, partial, details, details_key, locals); end

  # pkg:gem/actionview#lib/action_view/path_set.rb:47
  def find(path, prefixes, partial, details, details_key, locals); end

  # pkg:gem/actionview#lib/action_view/path_set.rb:52
  ...
  # pkg:gem/actionview#lib/action_view/path_set.rb:65
  def search_combinations(prefixes); end

  # pkg:gem/actionview#lib/action_view/path_set.rb:74
...
#   end
#
# pkg:gem/actionview#lib/action_view/record_identifier.rb:56
module ActionView::RecordIdentifier
  ...
  #
  # pkg:gem/actionview#lib/action_view/record_identifier.rb:74
  ...
  #
  # pkg:gem/actionview#lib/action_view/record_identifier.rb:89
  ...
  #
  # pkg:gem/actionview#lib/action_view/record_identifier.rb:106
  def record_key_for_dom_id(record); end
end

# pkg:gem/actionview#lib/action_view/record_identifier.rb:62
ActionView::RecordIdentifier::JOIN = T.let(T.unsafe(nil), String)

# pkg:gem/actionview#lib/action_view/record_identifier.rb:63
...
#
# pkg:gem/actionview#lib/action_view/renderer/renderer.rb:13
class ActionView::Renderer
  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:16
  def initialize(lookup_context); end

  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:56
  def cache_hits; end

  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:14
  def lookup_context; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:21
  ...
  #
  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:38
  ...
  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:64
  def render_partial_to_object(context, options, &block); end

  # Direct access to template rendering.
  #
  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:47
  def render_template(context, options); end

  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:60
  def render_template_to_object(context, options); end

  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:25
  def render_to_object(context, options); end

  private

  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:107
  def collection_from_object(object); end

  # pkg:gem/actionview#lib/action_view/renderer/renderer.rb:100
  def collection_from_options(options); end
end

# pkg:gem/actionview#lib/action_view/rendering.rb:25
module ActionView::Rendering
  ...
  # pkg:gem/actionview#lib/action_view/rendering.rb:31
  def initialize; end

  # Override process to set up I18n proxy.
  #
  # pkg:gem/actionview#lib/action_view/rendering.rb:37
  def process(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actionview#lib/action_view/rendering.rb:101
  def render_to_body(options = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/rendering.rb:29
  def rendered_format; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/rendering.rb:91
  def view_context; end

  # pkg:gem/actionview#lib/action_view/rendering.rb:77
  def view_context_class; end

  # Returns an object that is able to render templates.
  #
  # pkg:gem/actionview#lib/action_view/rendering.rb:96
  def view_renderer; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/rendering.rb:134
  def _normalize_args(action = T.unsafe(nil), options = T.unsafe(nil)); end

  # Normalize options.
  #
  # pkg:gem/actionview#lib/action_view/rendering.rb:158
  def _normalize_options(options); end
  ...
  #
  # pkg:gem/actionview#lib/action_view/rendering.rb:108
  def _render_template(options); end
end

# pkg:gem/actionview#lib/action_view/rendering.rb:44
module ActionView::Rendering::ClassMethods
  # pkg:gem/actionview#lib/action_view/rendering.rb:48
  def _helpers; end

  # pkg:gem/actionview#lib/action_view/rendering.rb:45
  def _routes; end

  # pkg:gem/actionview#lib/action_view/rendering.rb:51
  def build_view_context_class(klass, supports_path, routes, helpers); end

  # pkg:gem/actionview#lib/action_view/rendering.rb:64
  def view_context_class; end
end
...
class ActionView::Resolver
  # pkg:gem/actionview#lib/action_view/template/resolver.rb:68
  def all_template_paths; end
  ...
  # pkg:gem/actionview#lib/action_view/template/resolver.rb:74
  def _find_all(name, prefix, partial, details, key, locals); end
  ...
  # normalized.
  #
  # pkg:gem/actionview#lib/action_view/template/resolver.rb:83
...
class ActionView::Resolver::PathParser
  # pkg:gem/actionview#lib/action_view/template/resolver.rb:19
  def build_path_regex; end

  # pkg:gem/actionview#lib/action_view/template/resolver.rb:40
  def parse(path); end
end

# pkg:gem/actionview#lib/action_view/template/resolver.rb:17
...
# pkg:gem/actionview#lib/action_view/buffers.rb:41
class ActionView::StreamingBuffer
  # pkg:gem/actionview#lib/action_view/buffers.rb:42
  def initialize(block); end

  # pkg:gem/actionview#lib/action_view/buffers.rb:46
  def <<(value); end

  # pkg:gem/actionview#lib/action_view/buffers.rb:52
  def append=(value); end

  # pkg:gem/actionview#lib/action_view/buffers.rb:51
  def concat(value); end

  # pkg:gem/actionview#lib/action_view/buffers.rb:63
  def html_safe; end

  # pkg:gem/actionview#lib/action_view/buffers.rb:59
  def html_safe?; end

  # pkg:gem/actionview#lib/action_view/buffers.rb:57
  def safe_append=(value); end
...
# pkg:gem/actionview#lib/action_view/template/error.rb:232
class ActionView::SyntaxErrorInTemplate < ::ActionView::Template::Error
  ...
  # pkg:gem/actionview#lib/action_view/template/error.rb:238
  def message; end
end
...
class ActionView::Template
  ...
  # pkg:gem/actionview#lib/action_view/template.rb:123
  ...
  # pkg:gem/actionview#lib/action_view/template.rb:121
  def format; end

  # pkg:gem/actionview#lib/action_view/template.rb:120
  def handler; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/template.rb:229
  def marshal_dump; end

  # pkg:gem/actionview#lib/action_view/template.rb:233
  ...
  #
  # pkg:gem/actionview#lib/action_view/template.rb:154
  ...
  # pkg:gem/actionview#lib/action_view/template.rb:175
  def source; end

  # Returns whether the underlying handler supports streaming. If so,
  # a streaming buffer *may* be passed when it starts rendering.
  #
  # pkg:gem/actionview#lib/action_view/template.rb:144
  def supports_streaming?; end

  # pkg:gem/actionview#lib/action_view/template.rb:163
  def type; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/template.rb:275
  def compile(mod); end

  # Compile a template. This method ensures a template is compiled
  # just once and removes the source after it is compiled.
  #
  # pkg:gem/actionview#lib/action_view/template.rb:241
  def compile!(view); end

  # pkg:gem/actionview#lib/action_view/template.rb:316
  def handle_render_error(view, e); end

  # pkg:gem/actionview#lib/action_view/template.rb:352
  def identifier_method_name; end

  # pkg:gem/actionview#lib/action_view/template.rb:356
  def instrument(action, &block); end

  # pkg:gem/actionview#lib/action_view/template.rb:364
  def instrument_payload; end

  # pkg:gem/actionview#lib/action_view/template.rb:360
  def instrument_render_template(&block); end

  # pkg:gem/actionview#lib/action_view/template.rb:325
  def locals_code; end

  # pkg:gem/actionview#lib/action_view/template.rb:344
  def method_name; end

  class << self
    # pkg:gem/actionview#lib/action_view/template.rb:117
...
#
# pkg:gem/actionview#lib/action_view/template/error.rb:153
class ActionView::Template::Error < ::ActionView::ActionViewError
  # pkg:gem/actionview#lib/action_view/template/error.rb:159
  ...
  #
  # pkg:gem/actionview#lib/action_view/template/error.rb:157
  def cause; end

  # pkg:gem/actionview#lib/action_view/template/error.rb:166
  def file_name; end

  # pkg:gem/actionview#lib/action_view/template/error.rb:199
  def line_number; end

  # pkg:gem/actionview#lib/action_view/template/error.rb:179
  def source_extract(indentation = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/template/error.rb:170
...
# pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:6
class ActionView::Template::Handlers::ERB
  # pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:36
  def call(template, source); end
  ...
  # pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:11
  ...
  # pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:32
  ...
  # pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:28
  def supports_streaming?; end

  private

  # pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:68
  def valid_encoding(string, encoding); end

  class << self
    # pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:24
    def call(template, source); end
...
# pkg:gem/actionview#lib/action_view/template/handlers/erb.rb:22
...
class ActionView::Template::Handlers::ERB::Erubi < ::Erubi::Engine
  ...
  # pkg:gem/actionview#lib/action_view/template/handlers/erb/erubi.rb:26
  def evaluate(action_view_erb_handler_context); end

  private

  # pkg:gem/actionview#lib/action_view/template/handlers/erb/erubi.rb:69
  def add_code(code); end

  # pkg:gem/actionview#lib/action_view/template/handlers/erb/erubi.rb:53
  def add_expression(indicator, code); end

  # pkg:gem/actionview#lib/action_view/template/handlers/erb/erubi.rb:74
  def add_postamble(_); end

  # pkg:gem/actionview#lib/action_view/template/handlers/erb/erubi.rb:36
  def add_text(text); end

  # pkg:gem/actionview#lib/action_view/template/handlers/erb/erubi.rb:79
  def flush_newline_if_pending(src); end
end

# pkg:gem/actionview#lib/action_view/template/handlers/erb/erubi.rb:51
...
# pkg:gem/actionview#lib/action_view/template/types.rb:7
module ActionView::Template::Types
  class << self
    # pkg:gem/actionview#lib/action_view/template/types.rb:47
    def [](type); end

    # pkg:gem/actionview#lib/action_view/template/types.rb:43
    def delegate_to(klass); end

    # pkg:gem/actionview#lib/action_view/template/types.rb:51
    def symbols; end
...
# pkg:gem/actionview#lib/action_view/template/types.rb:8
class ActionView::Template::Types::Type
  # pkg:gem/actionview#lib/action_view/template/types.rb:21
  def initialize(symbol); end

  # pkg:gem/actionview#lib/action_view/template/types.rb:35
  def ==(type); end

  # pkg:gem/actionview#lib/action_view/template/types.rb:30
  def ref; end

  # pkg:gem/actionview#lib/action_view/template/types.rb:19
  def symbol; end

  # pkg:gem/actionview#lib/action_view/template/types.rb:25
  def to_s; end

  # pkg:gem/actionview#lib/action_view/template/types.rb:28
  def to_str; end
  ...
  class << self
    # pkg:gem/actionview#lib/action_view/template/types.rb:11
    def [](type); end
  end
end
...
# pkg:gem/actionview#lib/action_view/template/error.rb:230
...
#
# pkg:gem/actionview#lib/action_view/template_path.rb:9
class ActionView::TemplatePath
  # pkg:gem/actionview#lib/action_view/template_path.rb:45
  def initialize(name, prefix, partial, virtual); end

  # pkg:gem/actionview#lib/action_view/template_path.rb:62
  def ==(other); end

  # pkg:gem/actionview#lib/action_view/template_path.rb:59
  def eql?(other); end

  # pkg:gem/actionview#lib/action_view/template_path.rb:55
  def hash; end

  # pkg:gem/actionview#lib/action_view/template_path.rb:10
  def name; end
  ...
  # pkg:gem/actionview#lib/action_view/template_path.rb:53
  def to_s; end

  # pkg:gem/actionview#lib/action_view/template_path.rb:52
  def to_str; end
  ...
  class << self
    ...
    #
    # pkg:gem/actionview#lib/action_view/template_path.rb:41
    def build(name, prefix, partial); end

    # Build a TemplatePath form a virtual path
    #
    # pkg:gem/actionview#lib/action_view/template_path.rb:26
    def parse(virtual); end

    # Convert name, prefix, and partial into a virtual path string
    #
    # pkg:gem/actionview#lib/action_view/template_path.rb:15
...
class ActionView::TemplateRenderer < ::ActionView::AbstractRenderer
  ...
  #
  # pkg:gem/actionview#lib/action_view/renderer/template_renderer.rb:87
  ...
  # pkg:gem/actionview#lib/action_view/renderer/template_renderer.rb:70
  def render_with_layout(view, template, path, locals); end

  # pkg:gem/actionview#lib/action_view/renderer/template_renderer.rb:91
  def resolve_layout(layout, keys, formats); end
end

# = Action View Test Case
#
# pkg:gem/actionview#lib/action_view/test_case.rb:12
class ActionView::TestCase < ::ActiveSupport::TestCase
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:294
  ...
  class << self
    # pkg:gem/actionview#lib/action_view/test_case.rb:167
    def __callbacks; end
...
# pkg:gem/actionview#lib/action_view/test_case.rb:42
module ActionView::TestCase::Behavior
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:136
  def _routes; end

  # pkg:gem/actionview#lib/action_view/test_case.rb:122
  def config; end

  # pkg:gem/actionview#lib/action_view/test_case.rb:60
  def controller; end

  # pkg:gem/actionview#lib/action_view/test_case.rb:60
  def controller=(_arg0); end

  # pkg:gem/actionview#lib/action_view/test_case.rb:59
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:126
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:132
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:108
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:218
  def _view; end
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:265
  ...
  #
  # pkg:gem/actionview#lib/action_view/test_case.rb:207
  def view; end
...
module ActionView::TestCase::Behavior::ClassMethods
  # pkg:gem/actionview#lib/action_view/test_case.rb:72
  def determine_default_helper_class(name); end

  # pkg:gem/actionview#lib/action_view/test_case.rb:92
  def helper_class; end

  # pkg:gem/actionview#lib/action_view/test_case.rb:90
  def helper_class=(_arg0); end

  # pkg:gem/actionview#lib/action_view/test_case.rb:78
  def helper_method(*methods); end

  # pkg:gem/actionview#lib/action_view/test_case.rb:96
  def new(*_arg0); end
  ...
  # pkg:gem/actionview#lib/action_view/test_case.rb:102
...
module ActionView::TestCase::Behavior::Locals
  # pkg:gem/actionview#lib/action_view/test_case.rb:190
...
# Need to experiment if this priority is the best one: rendered => output_buffer
#
# pkg:gem/actionview#lib/action_view/test_case.rb:141
class ActionView::TestCase::Behavior::RenderedViewsCollection
  # pkg:gem/actionview#lib/action_view/test_case.rb:142
  def initialize; end

  # pkg:gem/actionview#lib/action_view/test_case.rb:146
  def add(view, locals); end

  # pkg:gem/actionview#lib/action_view/test_case.rb:151
  def locals_for(view); end

  # pkg:gem/actionview#lib/action_view/test_case.rb:155
  def rendered_views; end

  # pkg:gem/actionview#lib/action_view/test_case.rb:159
  def view_rendered?(view, expected_locals); end
end

# pkg:gem/actionview#lib/action_view/test_case.rb:294
module ActionView::TestCase::HelperMethods
  # pkg:gem/actionview#lib/action_view/test_case.rb:175
  def _test_case; end

  # pkg:gem/actionview#lib/action_view/test_case.rb:171
  def protect_against_forgery?; end
end

# pkg:gem/actionview#lib/action_view/test_case.rb:13
class ActionView::TestCase::TestController < ::ActionController::Base
  include ::ActionDispatch::TestProcess::FixtureFile
  include ::ActionDispatch::TestProcess

  # pkg:gem/actionview#lib/action_view/test_case.rb:31
  def initialize; end
  ...
  class << self
    # pkg:gem/actionview#lib/action_view/test_case.rb:27
    def controller_name; end

    # Overrides AbstractController::Base#controller_path
    #
    # pkg:gem/actionview#lib/action_view/test_case.rb:20
...
class ActionView::UnboundTemplate
  ...
  # pkg:gem/actionview#lib/action_view/unbound_template.rb:39
  def build_template(locals); end

  # pkg:gem/actionview#lib/action_view/unbound_template.rb:53
...
module ActionView::ViewPaths
  ...
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:90
  def _prefixes; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:112
  def append_view_path(path); end

  # pkg:gem/actionview#lib/action_view/view_paths.rb:102
  ...
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:97
  def lookup_context; end
  ...
  #   (see ActionView::PathSet for more information)
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:122
  ...
  class << self
    # pkg:gem/actionview#lib/action_view/view_paths.rb:84
    def all_view_paths; end

    # pkg:gem/actionview#lib/action_view/view_paths.rb:76
    def get_view_paths(klass); end

    # pkg:gem/actionview#lib/action_view/view_paths.rb:80
...
module ActionView::ViewPaths::ClassMethods
  ...
  #   (see ActionView::PathSet for more information)
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:37
  def append_view_path(path); end
  ...
  #   (see ActionView::PathSet for more information)
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:47
  def prepend_view_path(path); end

  # A list of all of the default view paths for this controller.
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:52
  def view_paths; end
  ...
  #
  # pkg:gem/actionview#lib/action_view/view_paths.rb:61
...
# pkg:gem/actionview#lib/action_view/template/error.rb:13
class ActionView::WrongEncodingError < ::ActionView::EncodingError
  ...
  # pkg:gem/actionview#lib/action_view/template/error.rb:18
  def message; end
end
