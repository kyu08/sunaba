...
module Puma
  class << self
    ...
    # pkg:gem/puma#lib/puma/detect.rb:25
    def osx?; end
    ...
    # pkg:gem/puma#lib/puma.rb:40
    def ssl?; end

    # @!attribute [rw] stats_object
    #
    # pkg:gem/puma#lib/puma.rb:64
    def stats; end

    # @!attribute [r] stats_hash
    # @version 5.0.0
    #
    # pkg:gem/puma#lib/puma.rb:70
    def stats_hash; end

    # @!attribute [rw] stats_object=
    #
    # pkg:gem/puma#lib/puma.rb:59
    def stats_object=(val); end

    # pkg:gem/puma#lib/puma/detect.rb:29
    def windows?; end
  end
end

# pkg:gem/puma#lib/puma/binder.rb:26
class Puma::Binder
  include ::Puma::Const

  # pkg:gem/puma#lib/puma/binder.rb:31
  def initialize(events, conf = T.unsafe(nil)); end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/binder.rb:67
  def activated_sockets; end

  # pkg:gem/puma#lib/puma/binder.rb:360
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/binder.rb:100
  def create_activated_fds(env_hash); end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/binder.rb:87
  ...
  # pkg:gem/puma#lib/puma/binder.rb:391
  def inherit_ssl_listener(fd, ctx); end

  # pkg:gem/puma#lib/puma/binder.rb:353
  def inherit_tcp_listener(host, port, fd); end

  # pkg:gem/puma#lib/puma/binder.rb:446
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/binder.rb:70
  def ios=(_arg0); end
  ...
  # pkg:gem/puma#lib/puma/binder.rb:309
  def localhost_authority; end

  # pkg:gem/puma#lib/puma/binder.rb:313
  def localhost_authority_context; end

  # pkg:gem/puma#lib/puma/binder.rb:155
  ...
  # pkg:gem/puma#lib/puma/binder.rb:468
  def redirects_for_restart; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/binder.rb:475
  ...
  #
  # pkg:gem/puma#lib/puma/binder.rb:128
  ...
  #
  # pkg:gem/puma#lib/puma/binder.rb:484
  def loopback_addresses; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/binder.rb:500
  def socket_activation_fd(int); end
end

# pkg:gem/puma#lib/puma/binder.rb:29
...
class Puma::Client
  ...
  # pkg:gem/puma#lib/puma/client.rb:71
  def initialize(io, env = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/client.rb:107
  def body; end

  # For the hijack protocol (allows us to just put the Client object
  # into the env)
  #
  # pkg:gem/puma#lib/puma/client.rb:129
  def call; end
  ...
  # pkg:gem/puma#lib/puma/client.rb:186
  def close; end

  # pkg:gem/puma#lib/puma/client.rb:114
  def closed?(*args, **_arg1, &block); end

  # pkg:gem/puma#lib/puma/client.rb:258
  def eagerly_finish; end

  # pkg:gem/puma#lib/puma/client.rb:107
  def env; end

  # pkg:gem/puma#lib/puma/client.rb:302
  def expect_proxy_proto=(val); end

  # pkg:gem/puma#lib/puma/client.rb:264
  ...
  #
  # pkg:gem/puma#lib/puma/client.rb:135
  def in_data_phase; end

  # @!attribute [r] inspect
  #
  # pkg:gem/puma#lib/puma/client.rb:123
  def inspect; end
  ...
  # pkg:gem/puma#lib/puma/client.rb:112
  def listener; end

  # pkg:gem/puma#lib/puma/client.rb:112
  def listener=(_arg0); end

  # pkg:gem/puma#lib/puma/client.rb:281
  def peerip; end
  ...
  # pkg:gem/puma#lib/puma/client.rb:139
  ...
  # pkg:gem/puma#lib/puma/client.rb:218
  def try_to_finish; end

  # If necessary, read the PROXY protocol from the buffer. Returns
  # false if more data is needed.
  #
  # pkg:gem/puma#lib/puma/client.rb:196
  def try_to_parse_proxy_protocol; end

  # pkg:gem/puma#lib/puma/client.rb:274
  def write_error(status_code); end

  private

  # pkg:gem/puma#lib/puma/client.rb:490
  def decode_chunk(chunk); end

  # pkg:gem/puma#lib/puma/client.rb:397
  def read_body; end

  # pkg:gem/puma#lib/puma/client.rb:442
  def read_chunked_body; end

  # pkg:gem/puma#lib/puma/client.rb:611
  def set_ready; end

  # pkg:gem/puma#lib/puma/client.rb:315
  def setup_body; end

  # pkg:gem/puma#lib/puma/client.rb:467
  def setup_chunked_body(body); end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/client.rb:486
...
# chunk header.
#
# pkg:gem/puma#lib/puma/client.rb:53
...
class Puma::Cluster < ::Puma::Runner
  # pkg:gem/puma#lib/puma/cluster.rb:20
  def initialize(cli, events); end

  # pkg:gem/puma#lib/puma/cluster.rb:149
  def all_workers_booted?; end

  # pkg:gem/puma#lib/puma/cluster.rb:153
  def check_workers; end

  # pkg:gem/puma#lib/puma/cluster.rb:132
  def cull_start_index(diff); end

  # pkg:gem/puma#lib/puma/cluster.rb:108
  def cull_workers; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/cluster.rb:276
  def fork_worker!; end
  ...
  #
  # pkg:gem/puma#lib/puma/cluster.rb:142
  def next_worker_index; end

  # pkg:gem/puma#lib/puma/cluster.rb:212
  def phased_restart; end

  # pkg:gem/puma#lib/puma/cluster.rb:271
  def preload?; end

  # pkg:gem/puma#lib/puma/cluster.rb:57
  def redirect_io; end

  # pkg:gem/puma#lib/puma/cluster.rb:238
  def reload_worker_directory; end

  # pkg:gem/puma#lib/puma/cluster.rb:207
  def restart; end

  # pkg:gem/puma#lib/puma/cluster.rb:336
  def run; end

  # We do this in a separate method to keep the lambda scope
  # of the signals handlers as small as possible.
  #
  # pkg:gem/puma#lib/puma/cluster.rb:285
  def setup_signals; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/cluster.rb:94
  def spawn_worker(idx, master); end

  # pkg:gem/puma#lib/puma/cluster.rb:63
  def spawn_workers; end

  # pkg:gem/puma#lib/puma/cluster.rb:45
  ...
  # pkg:gem/puma#lib/puma/cluster.rb:221
  def stop; end

  # pkg:gem/puma#lib/puma/cluster.rb:226
  def stop_blocked; end

  # pkg:gem/puma#lib/puma/cluster.rb:30
  def stop_workers; end

  # pkg:gem/puma#lib/puma/cluster.rb:185
  def worker(index, master); end

  # pkg:gem/puma#lib/puma/cluster.rb:122
  def workers_to_cull(diff); end

  private

  # pkg:gem/puma#lib/puma/cluster.rb:497
  def single_worker_warning; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/cluster.rb:532
  def timeout_workers; end

  # loops thru @workers, removing workers that exited, and calling
  # `#term` if needed
  #
  # pkg:gem/puma#lib/puma/cluster.rb:508
...
#
# pkg:gem/puma#lib/puma/cluster/worker.rb:11
class Puma::Cluster::Worker < ::Puma::Runner
  ...
  # pkg:gem/puma#lib/puma/cluster/worker.rb:12
  def index; end

  # pkg:gem/puma#lib/puma/cluster/worker.rb:12
  def master; end

  # pkg:gem/puma#lib/puma/cluster/worker.rb:28
  def run; end

  private

  # pkg:gem/puma#lib/puma/cluster/worker.rb:149
...
#
# pkg:gem/puma#lib/puma/cluster/worker_handle.rb:10
class Puma::Cluster::WorkerHandle
  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:11
  def initialize(idx, pid, phase, options); end

  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:38
  def boot!; end

  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:30
  def booted?; end

  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:88
  def hup; end

  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:25
  def index; end

  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:83
  def kill; end
  ...
  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:51
  def ping!(status); end

  # @see Puma::Cluster#check_workers
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:62
  ...
  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:70
  def term; end

  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:43
  def term!; end

  # pkg:gem/puma#lib/puma/cluster/worker_handle.rb:47
  def term?; end
...
# configuration files.
#
# pkg:gem/puma#lib/puma/configuration.rb:138
class Puma::Configuration
  include ::Puma::ConfigDefault

  # pkg:gem/puma#lib/puma/configuration.rb:141
  def initialize(user_options = T.unsafe(nil), default_options = T.unsafe(nil), &block); end

  # Load the specified rackup file, pull options from
  # the rackup file, and set @app.
  #
  # pkg:gem/puma#lib/puma/configuration.rb:269
  def app; end

  # Indicate if there is a properly configured app
  #
  # pkg:gem/puma#lib/puma/configuration.rb:258
  def app_configured?; end

  # Call once all configuration (included from rackup files)
  # is loaded to flesh out any defaults
  #
  # pkg:gem/puma#lib/puma/configuration.rb:239
  def clamp; end

  # pkg:gem/puma#lib/puma/configuration.rb:224
  def config_files; end

  # pkg:gem/puma#lib/puma/configuration.rb:161
  def configure; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/configuration.rb:185
  def default_max_threads; end

  # Return which environment we're running in
  #
  # pkg:gem/puma#lib/puma/configuration.rb:282
  def environment; end

  # pkg:gem/puma#lib/puma/configuration.rb:286
  def environment_str; end

  # pkg:gem/puma#lib/puma/configuration.rb:305
  def final_options; end

  # pkg:gem/puma#lib/puma/configuration.rb:175
  def flatten; end

  # pkg:gem/puma#lib/puma/configuration.rb:179
  def flatten!; end

  # pkg:gem/puma#lib/puma/configuration.rb:218
  def load; end

  # pkg:gem/puma#lib/puma/configuration.rb:290
  def load_plugin(name); end

  # pkg:gem/puma#lib/puma/configuration.rb:159
  def options; end

  # pkg:gem/puma#lib/puma/configuration.rb:159
  def plugins; end

  # pkg:gem/puma#lib/puma/configuration.rb:189
  def puma_default_options; end

  # pkg:gem/puma#lib/puma/configuration.rb:262
  def rackup; end
  ...
  # pkg:gem/puma#lib/puma/configuration.rb:318
  def infer_tag; end

  # pkg:gem/puma#lib/puma/configuration.rb:169
  def initialize_copy(other); end

  # pkg:gem/puma#lib/puma/configuration.rb:345
  def load_rackup; end

  # Load and use the normal Rack builder if we can, otherwise
  # fallback to our minimal version.
  #
  # pkg:gem/puma#lib/puma/configuration.rb:324
...
class Puma::Configuration::ConfigMiddleware
  ...
  # pkg:gem/puma#lib/puma/configuration.rb:250
  def call(env); end
end
...
# pkg:gem/puma#lib/puma/const.rb:187
...
#
# pkg:gem/puma#lib/puma/const.rb:155
...
# pkg:gem/puma#lib/puma/const.rb:133
...
# pkg:gem/puma#lib/puma/const.rb:139
...
# pkg:gem/puma#lib/puma/const.rb:183
...
# pkg:gem/puma#lib/puma/const.rb:176
...
# pkg:gem/puma#lib/puma/const.rb:135
...
# pkg:gem/puma#lib/puma/const.rb:178
Puma::Const::PORT_443 = T.let(T.unsafe(nil), String)

# pkg:gem/puma#lib/puma/const.rb:177
...
# pkg:gem/puma#lib/puma/const.rb:197
Puma::Const::PUMA_CONFIG = T.let(T.unsafe(nil), String)

# pkg:gem/puma#lib/puma/const.rb:198
...
# pkg:gem/puma#lib/puma/const.rb:196
Puma::Const::PUMA_SOCKET = T.let(T.unsafe(nil), String)

# pkg:gem/puma#lib/puma/const.rb:137
...
# +test/config+.
#
# pkg:gem/puma#lib/puma/dsl.rb:35
class Puma::DSL
  include ::Puma::ConfigDefault

  # pkg:gem/puma#lib/puma/dsl.rb:77
  def initialize(options, config); end

  # pkg:gem/puma#lib/puma/dsl.rb:84
  def _load_from(path); end

  # pkg:gem/puma#lib/puma/dsl.rb:93
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:167
  def activate_control_app(url = T.unsafe(nil), opts = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/dsl.rb:615
  ...
  #   end
  #
  # pkg:gem/puma#lib/puma/dsl.rb:610
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:145
  ...
  #   end
  #
  # pkg:gem/puma#lib/puma/dsl.rb:548
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:225
  def bind(url); end
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:256
  def bind_to_activated_sockets(bind = T.unsafe(nil)); end

  # Work around leaky apps that leave garbage in Thread locals
  # across requests.
  #
  # pkg:gem/puma#lib/puma/dsl.rb:283
  def clean_thread_locals(which = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/dsl.rb:230
  def clear_binds!; end

  # Show debugging info
  #
  # pkg:gem/puma#lib/puma/dsl.rb:376
  def debug; end

  # pkg:gem/puma#lib/puma/dsl.rb:108
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:660
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:292
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:303
  ...
  # @see Puma::Server#graceful_shutdown
  #
  # pkg:gem/puma#lib/puma/dsl.rb:315
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/dsl.rb:941
  def fork_worker(after_requests = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/dsl.rb:116
  def get(key, default = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/dsl.rb:112
  def inject(&blk); end
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:984
  def io_selector_backend(backend); end

  # Load additional configuration from a file
  # Files get loaded later via Configuration#load
  #
  # pkg:gem/puma#lib/puma/dsl.rb:194
  def load(file); end

  # pkg:gem/puma#lib/puma/dsl.rb:414
  def log_formatter(&block); end

  # Enable request logging
  #
  # pkg:gem/puma#lib/puma/dsl.rb:370
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/dsl.rb:958
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/dsl.rb:635
  ...
  #   end
  #
  # pkg:gem/puma#lib/puma/dsl.rb:337
  ...
  #   end
  #
  # pkg:gem/puma#lib/puma/dsl.rb:595
  ...
  #   end
  #
  # pkg:gem/puma#lib/puma/dsl.rb:580
  ...
  # This can be called multiple times to add several hooks.
  #
  # pkg:gem/puma#lib/puma/dsl.rb:649
  def out_of_band(&block); end

  # Define how long persistent connections can be idle before Puma closes them.
  # @see Puma::Server.new
  #
  # pkg:gem/puma#lib/puma/dsl.rb:271
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:122
  def plugin(name); end
  ...
  #   port 9292
  #
  # pkg:gem/puma#lib/puma/dsl.rb:264
  ...
  #   preload_app!
  #
  # pkg:gem/puma#lib/puma/dsl.rb:670
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:704
  ...
  # @see Puma::Server
  #
  # pkg:gem/puma#lib/puma/dsl.rb:851
  ...
  #   quiet
  #
  # pkg:gem/puma#lib/puma/dsl.rb:364
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:393
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:720
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:348
  def restart_command(cmd); end

  # pkg:gem/puma#lib/puma/dsl.rb:104
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:899
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:859
  ...
  # @note Cluster mode only.
  #
  # pkg:gem/puma#lib/puma/dsl.rb:530
  ...
  #   }
  #
  # pkg:gem/puma#lib/puma/dsl.rb:480
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:490
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/dsl.rb:500
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:408
  ...
  #   threads 5, 5
  #
  # pkg:gem/puma#lib/puma/dsl.rb:430
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:800
  ...
  # @see Puma::Cluster#check_workers
  #
  # pkg:gem/puma#lib/puma/dsl.rb:763
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:827
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:809
  ...
  # @see Puma::Cluster::Worker#ping_timeout
  #
  # pkg:gem/puma#lib/puma/dsl.rb:779
  ...
  # @see Puma::Cluster
  #
  # pkg:gem/puma#lib/puma/dsl.rb:512
  ...
  #
  # pkg:gem/puma#lib/puma/dsl.rb:996
  ...
  class << self
    ...
    # @see ssl_bind
    #
    # pkg:gem/puma#lib/puma/dsl.rb:41
...
class Puma::ErrorLogger
  ...
  #
  # pkg:gem/puma#lib/puma/error_logger.rb:45
  ...
  #   and before all remaining info.
  #
  # pkg:gem/puma#lib/puma/error_logger.rb:33
  def info(options = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/error_logger.rb:12
  def ioerr; end

  # pkg:gem/puma#lib/puma/error_logger.rb:71
  def request_dump(req); end

  # pkg:gem/puma#lib/puma/error_logger.rb:87
  def request_headers(req); end

  # pkg:gem/puma#lib/puma/error_logger.rb:92
  def request_parsed?(req); end

  # pkg:gem/puma#lib/puma/error_logger.rb:76
  def request_title(req); end

  # pkg:gem/puma#lib/puma/error_logger.rb:59
  ...
  class << self
    # pkg:gem/puma#lib/puma/error_logger.rb:22
    def stdio; end
  end
end
...
#
# pkg:gem/puma#lib/puma/events.rb:13
class Puma::Events
  # Create an Events object that prints to +stdout+ and +stderr+.
  #
  # pkg:gem/puma#lib/puma/events.rb:28
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/events.rb:95
  def connection_error(error, req, text = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/events.rb:75
  def debug(str); end
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/events.rb:131
  def debug_error(error, req = T.unsafe(nil), text = T.unsafe(nil)); end

  # Write +str+ to +@stderr+
  #
  # pkg:gem/puma#lib/puma/events.rb:81
  def error(str); end

  # Fire callbacks for the named hook
  #
  # pkg:gem/puma#lib/puma/events.rb:44
  def fire(hook, *args); end

  # pkg:gem/puma#lib/puma/events.rb:147
  def fire_on_booted!; end

  # pkg:gem/puma#lib/puma/events.rb:151
  def fire_on_restart!; end

  # pkg:gem/puma#lib/puma/events.rb:155
  def fire_on_stopped!; end

  # pkg:gem/puma#lib/puma/events.rb:86
  def format(str); end

  # pkg:gem/puma#lib/puma/events.rb:40
  def formatter; end
  ...
  # pkg:gem/puma#lib/puma/events.rb:135
  def on_booted(&block); end

  # pkg:gem/puma#lib/puma/events.rb:139
  def on_restart(&block); end

  # pkg:gem/puma#lib/puma/events.rb:143
  ...
  # and +req+ the request.
  #
  # pkg:gem/puma#lib/puma/events.rb:103
  ...
  #
  # pkg:gem/puma#lib/puma/events.rb:111
  def ssl_error(error, ssl_socket); end

  # pkg:gem/puma#lib/puma/events.rb:39
  def stderr; end
  ...
  # and +text+ additional info
  #
  # pkg:gem/puma#lib/puma/events.rb:122
  def unknown_error(error, req = T.unsafe(nil), text = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/events.rb:71
  def write(str); end

  class << self
    # pkg:gem/puma#lib/puma/events.rb:172
    def null; end

    # pkg:gem/puma#lib/puma/events.rb:168
    def stdio; end

    # Returns an Events object which writes its status to 2 StringIO
    # objects.
    #
    # pkg:gem/puma#lib/puma/events.rb:164
    def strings; end
  end
end

# pkg:gem/puma#lib/puma/events.rb:159
Puma::Events::DEFAULT = T.let(T.unsafe(nil), Puma::Events)

# pkg:gem/puma#lib/puma/events.rb:14
class Puma::Events::DefaultFormatter
  # pkg:gem/puma#lib/puma/events.rb:15
  def call(str); end
end

# pkg:gem/puma#lib/puma/events.rb:20
...
# not in minissl.rb
#
# pkg:gem/puma#lib/puma.rb:26
Puma::HAS_SSL = T.let(T.unsafe(nil), TrueClass)

# pkg:gem/puma#lib/puma.rb:28
...
# pkg:gem/puma#lib/puma/io_buffer.rb:4
class Puma::IOBuffer < ::String
  # pkg:gem/puma#lib/puma/io_buffer.rb:5
  def append(*args); end

  # pkg:gem/puma#lib/puma/io_buffer.rb:9
  def reset; end
end
...
# puma server.
#
# pkg:gem/puma#lib/puma/launcher.rb:17
class Puma::Launcher
  ...
  # pkg:gem/puma#lib/puma/launcher.rb:102
  def binder; end

  # pkg:gem/puma#lib/puma/launcher.rb:229
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/launcher.rb:215
  def connected_ports; end

  # Delete the configured pidfile
  #
  # pkg:gem/puma#lib/puma/launcher.rb:130
  ...
  #
  # pkg:gem/puma#lib/puma/launcher.rb:136
  def halt; end
  ...
  #
  # pkg:gem/puma#lib/puma/launcher.rb:154
  def phased_restart; end

  # Begin a refork if supported
  #
  # pkg:gem/puma#lib/puma/launcher.rb:163
  def refork; end

  # Begin async restart of the server
  #
  # pkg:gem/puma#lib/puma/launcher.rb:148
  def restart; end

  # @!attribute [r] restart_args
  #
  # pkg:gem/puma#lib/puma/launcher.rb:220
  ...
  #
  # pkg:gem/puma#lib/puma/launcher.rb:174
  def run; end

  # Return stats about the server
  #
  # pkg:gem/puma#lib/puma/launcher.rb:105
  def stats; end

  # Begin async shutdown of the server gracefully
  #
  # pkg:gem/puma#lib/puma/launcher.rb:142
  def stop; end

  # @!attribute [r] thread_status
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/launcher.rb:240
  def thread_status; end

  # Write a state file that can be used by pumactl to control
  # the server
  #
  # pkg:gem/puma#lib/puma/launcher.rb:111
  def write_state; end

  private

  # pkg:gem/puma#lib/puma/launcher.rb:383
  def clustered?; end

  # @!attribute [r] environment
  #
  # pkg:gem/puma#lib/puma/launcher.rb:414
  def environment; end

  # @!attribute [r] extra_runtime_deps_directories
  #
  # pkg:gem/puma#lib/puma/launcher.rb:301
  def extra_runtime_deps_directories; end

  # @!attribute [r] files_to_require_after_prune
  #
  # pkg:gem/puma#lib/puma/launcher.rb:294
  def files_to_require_after_prune; end

  # pkg:gem/puma#lib/puma/launcher.rb:422
  def generate_restart_data; end

  # pkg:gem/puma#lib/puma/launcher.rb:392
  ...
  #
  # pkg:gem/puma#lib/puma/launcher.rb:354
  def integrate_with_systemd; end

  # pkg:gem/puma#lib/puma/launcher.rb:379
  def log(str); end

  # pkg:gem/puma#lib/puma/launcher.rb:548
  def log_config; end

  # pkg:gem/puma#lib/puma/launcher.rb:320
  def prune_bundler; end

  # pkg:gem/puma#lib/puma/launcher.rb:418
  def prune_bundler?; end

  # @!attribute [r] puma_wild_location
  #
  # pkg:gem/puma#lib/puma/launcher.rb:313
  def puma_wild_location; end

  # pkg:gem/puma#lib/puma/launcher.rb:265
  def reload_worker_directory; end

  # pkg:gem/puma#lib/puma/launcher.rb:375
  def require_paths_for_gem(gem_spec); end

  # pkg:gem/puma#lib/puma/launcher.rb:531
  def require_rubygems_min_version!(min_version, feature); end

  # pkg:gem/puma#lib/puma/launcher.rb:269
  def restart!; end

  # pkg:gem/puma#lib/puma/launcher.rb:397
  def set_process_title; end

  # pkg:gem/puma#lib/puma/launcher.rb:408
  def set_rack_environment; end

  # pkg:gem/puma#lib/puma/launcher.rb:467
  def setup_signals; end
  ...
  # @!attribute [r] title
  #
  # pkg:gem/puma#lib/puma/launcher.rb:402
  def title; end

  # pkg:gem/puma#lib/puma/launcher.rb:387
  def unsupported(str); end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/launcher.rb:539
  def with_unbundled_env; end

  # If configured, write the pid of the current process out
  # to a file.
  #
  # pkg:gem/puma#lib/puma/launcher.rb:255
  def write_pid; end
end

# @deprecated 6.0.0
#
# pkg:gem/puma#lib/puma/launcher.rb:19
Puma::Launcher::KEYS_NOT_TO_PERSIST_IN_STATE = T.let(T.unsafe(nil), Array)

# pkg:gem/puma#lib/puma/minissl.rb:12
module Puma::MiniSSL
  class << self
    def check; end
  end
...
# pkg:gem/puma#lib/puma/minissl.rb:204
class Puma::MiniSSL::Context
  # pkg:gem/puma#lib/puma/minissl.rb:208
  def initialize; end

  # pkg:gem/puma#lib/puma/minissl.rb:241
  def ca; end

  # pkg:gem/puma#lib/puma/minissl.rb:257
  def ca=(ca); end

  # pkg:gem/puma#lib/puma/minissl.rb:240
  def cert; end

  # pkg:gem/puma#lib/puma/minissl.rb:252
  def cert=(cert); end

  # pkg:gem/puma#lib/puma/minissl.rb:242
  def cert_pem; end

  # pkg:gem/puma#lib/puma/minissl.rb:262
  def cert_pem=(cert_pem); end

  # pkg:gem/puma#lib/puma/minissl.rb:272
  def check; end

  # pkg:gem/puma#lib/puma/minissl.rb:217
  def check_file(file, desc); end

  # non-jruby Context properties
  #
  # pkg:gem/puma#lib/puma/minissl.rb:239
  def key; end

  # pkg:gem/puma#lib/puma/minissl.rb:247
  def key=(key); end

  # pkg:gem/puma#lib/puma/minissl.rb:243
  def key_pem; end

  # pkg:gem/puma#lib/puma/minissl.rb:267
  def key_pem=(key_pem); end

  # pkg:gem/puma#lib/puma/minissl.rb:206
  def no_tlsv1; end

  # disables TLSv1
  # @!attribute [w] no_tlsv1=
  #
  # pkg:gem/puma#lib/puma/minissl.rb:280
...
class Puma::MiniSSL::ContextBuilder
  ...
  # pkg:gem/puma#lib/puma/minissl/context_builder.rb:78
  def events; end
...
# @version 5.0.0
#
# pkg:gem/puma#lib/puma/minissl.rb:16
...
# pkg:gem/puma#lib/puma/minissl.rb:324
class Puma::MiniSSL::Server
  ...
  # pkg:gem/puma#lib/puma/minissl.rb:338
  def accept_nonblock; end

  # @!attribute [r] addr
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/minissl.rb:352
  def addr; end

  # pkg:gem/puma#lib/puma/minissl.rb:356
  def close; end

  # pkg:gem/puma#lib/puma/minissl.rb:360
  def closed?; end

  # @!attribute [r] to_io
  #
  # pkg:gem/puma#lib/puma/minissl.rb:346
  def to_io; end
end

# pkg:gem/puma#lib/puma/minissl.rb:20
class Puma::MiniSSL::Socket
  # pkg:gem/puma#lib/puma/minissl.rb:21
  def initialize(socket, engine); end

  # pkg:gem/puma#lib/puma/minissl.rb:141
  def <<(data); end

  # pkg:gem/puma#lib/puma/minissl.rb:164
  def close; end

  # pkg:gem/puma#lib/puma/minissl.rb:32
  def closed?; end

  # pkg:gem/puma#lib/puma/minissl.rb:74
  def engine_read_all; end

  # pkg:gem/puma#lib/puma/minissl.rb:160
  def flush; end

  # @!attribute [r] peeraddr
  #
  # pkg:gem/puma#lib/puma/minissl.rb:180
  def peeraddr; end

  # @!attribute [r] peercert
  #
  # pkg:gem/puma#lib/puma/minissl.rb:185
  def peercert; end

  # pkg:gem/puma#lib/puma/minissl.rb:82
  def read_nonblock(size, *_); end

  # pkg:gem/puma#lib/puma/minissl.rb:57
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/minissl.rb:45
  def ssl_version_state; end

  # pkg:gem/puma#lib/puma/minissl.rb:140
  def syswrite(data); end

  # @!attribute [r] to_io
  #
  # pkg:gem/puma#lib/puma/minissl.rb:28
  def to_io; end

  # pkg:gem/puma#lib/puma/minissl.rb:117
  def write(data); end
  ...
  #
  # pkg:gem/puma#lib/puma/minissl.rb:156
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/minissl.rb:52
  def bad_tlsv1_3?; end
end
...
#
# pkg:gem/puma#lib/puma/minissl.rb:300
...
class Puma::NullIO
  # pkg:gem/puma#lib/puma/null_io.rb:28
  def close; end

  # This is used as singleton class, so can't have state.
  #
  # pkg:gem/puma#lib/puma/null_io.rb:57
  def closed?; end

  # pkg:gem/puma#lib/puma/null_io.rb:16
  def each; end

  # pkg:gem/puma#lib/puma/null_io.rb:35
  def eof?; end

  # pkg:gem/puma#lib/puma/null_io.rb:52
  def flush; end
...
# pkg:gem/puma#lib/puma/rack/builder.rb:6
...
#
# pkg:gem/puma#lib/puma/rack/builder.rb:154
class Puma::Rack::Builder
  # pkg:gem/puma#lib/puma/rack/builder.rb:176
  def initialize(default_app = T.unsafe(nil), &block); end

  # pkg:gem/puma#lib/puma/rack/builder.rb:283
  def call(env); end
  ...
  #
  # pkg:gem/puma#lib/puma/rack/builder.rb:270
  ...
  #   run Heartbeat
  #
  # pkg:gem/puma#lib/puma/rack/builder.rb:234
  def run(app); end

  # pkg:gem/puma#lib/puma/rack/builder.rb:275
  def to_app; end
  ...
  #
  # pkg:gem/puma#lib/puma/rack/builder.rb:212
  ...
  #   run MyApp
  #
  # pkg:gem/puma#lib/puma/rack/builder.rb:247
  def warmup(prc = T.unsafe(nil), &block); end

  private

  # pkg:gem/puma#lib/puma/rack/builder.rb:289
  def generate_map(default_app, mapping); end

  class << self
    # pkg:gem/puma#lib/puma/rack/builder.rb:189
    def app(default_app = T.unsafe(nil), &block); end

    # pkg:gem/puma#lib/puma/rack/builder.rb:171
    def new_from_string(builder_script, file = T.unsafe(nil)); end

    # pkg:gem/puma#lib/puma/rack/builder.rb:155
    def parse_file(config, opts = T.unsafe(nil)); end
  end
end

# pkg:gem/puma#lib/puma/rack/builder.rb:7
class Puma::Rack::Options
  # pkg:gem/puma#lib/puma/rack/builder.rb:101
  def handler_opts(options); end

  # pkg:gem/puma#lib/puma/rack/builder.rb:8
  def parse!(args); end
end
...
#
# pkg:gem/puma#lib/puma/reactor.rb:19
class Puma::Reactor
  # Create a new Reactor to monitor IO objects added by #add.
  # The provided block will be invoked when an IO has data available to read,
  # its timeout elapses, or when the Reactor shuts down.
  #
  # pkg:gem/puma#lib/puma/reactor.rb:23
  ...
  #
  # pkg:gem/puma#lib/puma/reactor.rb:100
...
# @version 5.0.3
#
# pkg:gem/puma#lib/puma/request.rb:13
module Puma::Request
  include ::Puma::Const
  ...
  #
  # pkg:gem/puma#lib/puma/request.rb:194
  ...
  #
  # pkg:gem/puma#lib/puma/request.rb:242
  ...
  #
  # pkg:gem/puma#lib/puma/request.rb:207
  def fast_write(io, str); end

  # @param status [Integer] status from the app
  # @return [String] the text description from Puma::HTTP_STATUS_CODES
  #
  # pkg:gem/puma#lib/puma/request.rb:231
  def fetch_status_code(status); end

  # @param header_key [#to_s]
  # @return [Boolean]
  #
  # pkg:gem/puma#lib/puma/request.rb:303
  def illegal_header_key?(header_key); end

  # @param header_value [#to_s]
  # @return [Boolean]
  #
  # pkg:gem/puma#lib/puma/request.rb:310
  ...
  # @version 5.0.3
  #
  # pkg:gem/puma#lib/puma/request.rb:329
  ...
  # @version 5.0.3
  #
  # pkg:gem/puma#lib/puma/request.rb:369
  ...
  # @version 5.0.3
  #
  # pkg:gem/puma#lib/puma/request.rb:397
...
class Puma::Runner
  # pkg:gem/puma#lib/puma/runner.rb:11
  def initialize(cli, events); end

  # @!attribute [r] app
  #
  # pkg:gem/puma#lib/puma/runner.rb:160
  def app; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/runner.rb:77
  ...
  # pkg:gem/puma#lib/puma/runner.rb:143
  def load_and_bind; end

  # pkg:gem/puma#lib/puma/runner.rb:38
  def log(str); end

  # pkg:gem/puma#lib/puma/runner.rb:94
  def output_header(mode); end

  # pkg:gem/puma#lib/puma/runner.rb:116
  def redirect_io; end
  ...
  #
  # pkg:gem/puma#lib/puma/runner.rb:82
  def ruby_engine; end

  # pkg:gem/puma#lib/puma/runner.rb:55
  def start_control; end

  # pkg:gem/puma#lib/puma/runner.rb:164
  ...
  # pkg:gem/puma#lib/puma/runner.rb:34
  def test?; end

  # pkg:gem/puma#lib/puma/runner.rb:21
  def wakeup!; end

  private

  # pkg:gem/puma#lib/puma/runner.rb:171
...
class Puma::Server
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:74
  ...
  # pkg:gem/puma#lib/puma/server.rb:54
  def app; end
  ...
  # @!attribute [r] backlog
  #
  # pkg:gem/puma#lib/puma/server.rb:197
  def backlog; end

  # pkg:gem/puma#lib/puma/server.rb:609
  def begin_restart(sync = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/server.rb:55
  def binder; end
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:509
  ...
  # 1/0 == turn on/off
  #
  # pkg:gem/puma#lib/puma/server.rb:164
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:552
  def graceful_shutdown; end

  # pkg:gem/puma#lib/puma/server.rb:604
  def halt(sync = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/server.rb:389
  def handle_check; end

  # pkg:gem/puma#lib/puma/server.rb:312
  def handle_servers; end

  # pkg:gem/puma#lib/puma/server.rb:113
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:531
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:215
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:417
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:296
  ...
  #
  # pkg:gem/puma#lib/puma/server.rb:225
  def run(background = T.unsafe(nil), thread_name: T.unsafe(nil)); end

  # @!attribute [r] running
  #
  # pkg:gem/puma#lib/puma/server.rb:202
  def running; end
  ...
  # @!attribute [r] stats
  #
  # pkg:gem/puma#lib/puma/server.rb:625
  def stats; end

  # Stops the acceptor thread and then causes the worker threads to finish
  # off the request queue before finally exiting.
  #
  # pkg:gem/puma#lib/puma/server.rb:599
  def stop(sync = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/server.rb:38
  def thread; end

  # pkg:gem/puma#lib/puma/server.rb:167
  def uncork_socket(socket); end

  # Triggers a client timeout if the thread-pool shuts down
  # during execution of the provided block.
  #
  # pkg:gem/puma#lib/puma/server.rb:500
  def with_force_shutdown(client, &block); end

  private

  # pkg:gem/puma#lib/puma/server.rb:581
  def notify_safely(message); end

  class << self
    # @!attribute [r] current
    #
    # pkg:gem/puma#lib/puma/server.rb:119
    def current; end
    ...
    # @version 5.0.0
    #
    # pkg:gem/puma#lib/puma/server.rb:131
    def closed_socket_supported?; end

    # @version 5.0.0
    #
    # pkg:gem/puma#lib/puma/server.rb:125
...
# pkg:gem/puma#lib/puma/server.rb:60
...
# and processes it.
#
# pkg:gem/puma#lib/puma/thread_pool.rb:17
class Puma::ThreadPool
  ...
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:185
  def <<(work); end

  # pkg:gem/puma#lib/puma/thread_pool.rb:327
  def auto_reap!(timeout = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/thread_pool.rb:322
  ...
  # pkg:gem/puma#lib/puma/thread_pool.rb:71
  def clean_thread_locals; end

  # pkg:gem/puma#lib/puma/thread_pool.rb:71
  def clean_thread_locals=(_arg0); end

  # pkg:gem/puma#lib/puma/thread_pool.rb:72
  ...
  # @!attribute [r] pool_capacity
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:87
  def pool_capacity; end

  # If there are dead threads in the pool make them go away while decreasing
  # spawned counter so that new healthy threads could be created again.
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:280
  def reap; end
  ...
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:350
  def shutdown(timeout = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/thread_pool.rb:70
  def spawned; end
  ...
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:268
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:244
  ...
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:334
  def with_force_shutdown; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:178
  ...
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:101
  def spawn_thread; end

  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/thread_pool.rb:162
  def trigger_out_of_band_hook; end

  class << self
    # @version 5.0.0
    #
    # pkg:gem/puma#lib/puma/thread_pool.rb:74
    def clean_thread_locals; end
  end
end
...
class Puma::ThreadPool::Automaton
  # pkg:gem/puma#lib/puma/thread_pool.rb:296
  def initialize(pool, timeout, thread_name, message); end

  # pkg:gem/puma#lib/puma/thread_pool.rb:304
  def start!; end

  # pkg:gem/puma#lib/puma/thread_pool.rb:316
  def stop; end
end

# pkg:gem/puma#lib/puma/thread_pool.rb:18
...
# pkg:gem/puma#lib/puma/reactor.rb:6
...
class Puma::UserFileDefaultOptions
  # pkg:gem/puma#lib/puma/configuration.rb:49
  def initialize(user_options, default_options); end

  # pkg:gem/puma#lib/puma/configuration.rb:57
  def [](key); end

  # pkg:gem/puma#lib/puma/configuration.rb:61
  def []=(key, value); end

  # pkg:gem/puma#lib/puma/configuration.rb:73
  def all_of(key); end

  # pkg:gem/puma#lib/puma/configuration.rb:55
  def default_options; end

  # pkg:gem/puma#lib/puma/configuration.rb:65
  def fetch(key, default_value = T.unsafe(nil)); end

  # pkg:gem/puma#lib/puma/configuration.rb:55
  def file_options; end

  # pkg:gem/puma#lib/puma/configuration.rb:97
  def final_options; end

  # pkg:gem/puma#lib/puma/configuration.rb:89
...
module Puma::Util
  ...
  # @version 5.0.0
  #
  # pkg:gem/puma#lib/puma/util.rb:43
  ...
  #
  # pkg:gem/puma#lib/puma/util.rb:60
...
# pkg:gem/puma#lib/puma/util.rb:53
...
class Puma::Util::HeaderHash < ::Hash
  # pkg:gem/puma#lib/puma/util.rb:90
  ...
  # pkg:gem/puma#lib/puma/util.rb:96
  def each; end

  # pkg:gem/puma#lib/puma/util.rb:131
  def has_key?(k); end

  # pkg:gem/puma#lib/puma/util.rb:127
  def include?(k); end

  # pkg:gem/puma#lib/puma/util.rb:133
  def key?(k); end

  # pkg:gem/puma#lib/puma/util.rb:132
  def member?(k); end

  # pkg:gem/puma#lib/puma/util.rb:140
  def merge(other); end

  # pkg:gem/puma#lib/puma/util.rb:135
  def merge!(other); end

  # pkg:gem/puma#lib/puma/util.rb:145
  def replace(other); end

  # @!attribute [r] to_hash
  #
  # pkg:gem/puma#lib/puma/util.rb:103
  def to_hash; end

  class << self
    # pkg:gem/puma#lib/puma/util.rb:86
